...
namespace CRUD_TP2 {
    ...
    public partial class FuncionarioDataSet : global::System.Data.DataSet {
        ...
        public partial class FUNCIONARIODataTable : global::System.Data.TypedTableBase<FUNCIONARIORow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public FUNCIONARIORow AddFUNCIONARIORow(string NOME, string EMAIL, string TELEFONE, string SETOR, string CARGO) {
...
namespace CRUD_TP2.FuncionarioDataSetTableAdapters {
    ...
    public partial class FUNCIONARIOTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[FUNCIONARIO] WHERE (([ID] = @Original_ID) AND ((@IsNull_NOME = 1 AND [NOME] IS NULL) OR ([NOME] = @Original_NOME)) AND ((@IsNull_EMAIL = 1 AND [EMAIL] IS NULL) OR ([EMAIL] = @Original_EMAIL)) AND ((@IsNull_TELEFONE = 1 AND [TELEFONE] IS NULL) OR ([TELEFONE] = @Original_TELEFONE)) AND ((@IsNull_SETOR = 1 AND [SETOR] IS NULL) OR ([SETOR] = @Original_SETOR)) AND ((@IsNull_CARGO = 1 AND [CARGO] IS NULL) OR ([CARGO] = @Original_CARGO)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[FUNCIONARIO] ([NOME], [EMAIL], [TELEFONE], [SETOR], [CARGO]) V" +
                "ALUES (@NOME, @EMAIL, @TELEFONE, @SETOR, @CARGO);\r\nSELECT ID, NOME, EMAIL, TELEF" +
                "ONE, SETOR, CARGO FROM FUNCIONARIO WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[FUNCIONARIO] SET [NOME] = @NOME, [EMAIL] = @EMAIL, [TELEFONE] = @TELEFONE, [SETOR] = @SETOR, [CARGO] = @CARGO WHERE (([ID] = @Original_ID) AND ((@IsNull_NOME = 1 AND [NOME] IS NULL) OR ([NOME] = @Original_NOME)) AND ((@IsNull_EMAIL = 1 AND [EMAIL] IS NULL) OR ([EMAIL] = @Original_EMAIL)) AND ((@IsNull_TELEFONE = 1 AND [TELEFONE] IS NULL) OR ([TELEFONE] = @Original_TELEFONE)) AND ((@IsNull_SETOR = 1 AND [SETOR] IS NULL) OR ([SETOR] = @Original_SETOR)) AND ((@IsNull_CARGO = 1 AND [CARGO] IS NULL) OR ([CARGO] = @Original_CARGO)));
SELECT ID, NOME, EMAIL, TELEFONE, SETOR, CARGO FROM FUNCIONARIO WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_TP2.Properties.Settings.Default.FuncionarioConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, NOME, EMAIL, TELEFONE, SETOR, CARGO FROM dbo.FUNCIONARIO";
        ...
        public virtual int Delete(int Original_ID, string Original_NOME, string Original_EMAIL, string Original_TELEFONE, string Original_SETOR, string Original_CARGO) {
        ...
        public virtual int Insert(string NOME, string EMAIL, string TELEFONE, string SETOR, string CARGO) {
            if ((NOME == null)) {
        ...
        public virtual int Update(string NOME, string EMAIL, string TELEFONE, string SETOR, string CARGO, int Original_ID, string Original_NOME, string Original_EMAIL, string Original_TELEFONE, string Original_SETOR, string Original_CARGO, int ID) {
            if ((NOME == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NOME, string EMAIL, string TELEFONE, string SETOR, string CARGO, int Original_ID, string Original_NOME, string Original_EMAIL, string Original_TELEFONE, string Original_SETOR, string Original_CARGO) {
            return this.Update(NOME, EMAIL, TELEFONE, SETOR, CARGO, Original_ID, Original_NOME, Original_EMAIL, Original_TELEFONE, Original_SETOR, Original_CARGO, Original_ID);
        }
    }
